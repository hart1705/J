...
namespace PORTAL.DAL.EF.Migrations
{
    ...
    [Migration("20180809043427_bayanihanf1")]
    partial class bayanihanf1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PORTAL.DAL.EF.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("BayanihanId")
                        .IsUnique()
                        .HasFilter("[BayanihanId] IS NOT NULL");
            ...
            modelBuilder.Entity("PORTAL.DAL.EF.Models.ApplicationUser", b =>
                {
                    b.HasOne("PORTAL.DAL.EF.Models.Bayanihan", "Bayanihan")
                        .WithOne()
                        .HasForeignKey("PORTAL.DAL.EF.Models.ApplicationUser", "BayanihanId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("PORTAL.DAL.EF.Models.Income", "Income")
                        .WithOne()
                        .HasForeignKey("PORTAL.DAL.EF.Models.ApplicationUser", "IncomeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
